...
# TASK: Create a new variable, good_movies, and set it equal to the result of calling .select on movie_ratings, selecting only movies with a rating strictly greater than 3.
# HINT: You’ll want to select for values that are > 3 (not >= 3)!
...
# Add your code below!
# movie_rating.select {|name, rate| good_movies > 3}
...
# TASK: Go ahead and print out just the titles of our movies using puts.
